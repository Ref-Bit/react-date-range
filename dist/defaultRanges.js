...
var defineds = {
  ...
  startOfFirstQuarter: (0, _dateFns.startOfQuarter)(new Date(currentYear, 1, 1)),
  endOfFirstQuarter: (0, _dateFns.endOfQuarter)(new Date(currentYear, 1, 1)),
  startOfSecondQuarter: (0, _dateFns.startOfQuarter)(new Date(currentYear, 4, 1)),
  endOfSecondQuarter: (0, _dateFns.endOfQuarter)(new Date(currentYear, 4, 1)),
  startOfThirdQuarter: (0, _dateFns.startOfQuarter)(new Date(currentYear, 7, 1)),
  endOfThirdQuarter: (0, _dateFns.endOfQuarter)(new Date(currentYear, 7, 1)),
  startOfFourthQuarter: (0, _dateFns.startOfQuarter)(new Date(currentYear, 10, 1)),
  endOfFourthQuarter: (0, _dateFns.endOfQuarter)(new Date(currentYear, 10, 1))
};
